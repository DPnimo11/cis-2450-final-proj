...
from src.config import FEATURE_DATASET_PATH, RAW_MERGED_DATA_PATH
...
def load_feature_data(path=FEATURE_DATASET_PATH) -> pl.DataFrame:
    """Load the final processed feature dataset used for modeling."""
    df = pl.read_csv(path)
